export const GAME_KEYWORDS = [
  ...
  { name: "Smash", rule: "You may discard another card from your hand to gain the listed number of attack (e.g. “Smash 3” = +3 attack).", aliases: ["Smashes", "Smashed", "Smashing", "Smasher", "Smashers"], matchPattern: '\\bSmash(es|ed|ing|er|ers)?(\\s+\\d+)?\\b' },
